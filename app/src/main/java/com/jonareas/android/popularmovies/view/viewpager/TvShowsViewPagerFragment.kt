...
import com.jonareas.android.popularmovies.adapter.TvShowsViewPagerAdapter
import com.jonareas.android.popularmovies.databinding.FragmentHomeViewPagerBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class TvShowsViewPagerFragment : Fragment() {
    ...
    private fun setupViewPagerWithTabLayout() : Unit = binding.run {
        val homeAdapter = TvShowsViewPagerAdapter(childFragmentManager, lifecycle)
