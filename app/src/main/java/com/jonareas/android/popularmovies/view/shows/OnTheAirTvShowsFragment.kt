...
@AndroidEntryPoint
class OnTheAirTvShowsFragment : Fragment() {

    private val viewModel : OnTheAirTvShowsViewModel by viewModels()
    ...
    private fun initObservers() : Unit = binding.run {
        ...
        viewModel.onTheAirTvShows.observe(viewLifecycleOwner) { listOfTvShows ->
            listOfTvShows?.let {
