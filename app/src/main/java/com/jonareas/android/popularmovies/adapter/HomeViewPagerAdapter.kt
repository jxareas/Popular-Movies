...
import com.jonareas.android.popularmovies.view.movies.BestMoviesFragment
...
class HomeViewPagerAdapter(fragmentManager: FragmentManager, lifecycle: Lifecycle) :
    ...
    private val fragments : Set<Fragment> = setOf(MovieListFragment(), TopMoviesListFragment(), BestMoviesFragment(), PreferencesFragment())

    val titles : Set<Int> = setOf(R.string.popular, R.string.hot, R.string.top, R.string.settings)
